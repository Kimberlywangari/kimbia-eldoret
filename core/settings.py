...
# This looks for a secret key on Render first, then falls back to your local one.
...
# This compresses your CSS/JS and gives them unique names for better caching
STORAGES = {
    "staticfiles": {
